...
export default function TasksLoading() {
  return (
    <div className="animate-page-in space-y-6" role="status" aria-label="Loading tasks">
        ...
        {[0, 1].map((item) => (
          <Card className="overflow-hidden" key={item}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="skeleton-shimmer h-20 rounded bg-muted" />
        ...
        {[0, 1, 2].map((item) => (
          <Card className="overflow-hidden" key={item}>
            <CardContent className="space-y-4 p-5">
              ...
              <div className="skeleton-shimmer h-4 w-44 rounded bg-muted" />
            </CardContent>
          </Card>
        ))}
      </section>
